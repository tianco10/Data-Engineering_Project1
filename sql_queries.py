...
songplay_table_create =  "CREATE TABLE IF NOT EXISTS songplays \
                          (songplay_id serial, start_time timestamp, user_id int, level varchar, song_id varchar, \
                           artist_id varchar, session_id int, location varchar, user_agent varchar, PRIMARY KEY (songplay_id))"

user_table_create = "CREATE TABLE IF NOT EXISTS users \
                     (user_id int, first_name varchar, last_name varchar, gender varchar, level varchar, PRIMARY KEY (user_id))"

song_table_create = "CREATE TABLE IF NOT EXISTS songs \
                     (song_id varchar, title varchar, artist_id varchar, year int, duration float, PRIMARY KEY (song_id))"
